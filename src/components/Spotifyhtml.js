...
export default function Spotifyhtml()  {
  ...
  return (
    <div>
      ...
      <Card>
                <Card.Body>
                  <Box sx={{marginLeft:'156px', marginRight:'156px', marginTop:'64px'}}>
                  ...
                  <Box sx={{marginTop:'24px'}}>
                    ...
                    <Box sx={{margin:'24px'}}>
                      <h2 className='mb-4'><b>Verse</b></h2>
                    </Box>
                  <Box sx={{margin:'24px'}}>
                    <Typography variant="h6" gutterBottom component="div"> Hey! To find matches, we need access to your spotify data. </Typography>
                    <Typography variant="h6" gutterBottom component="div"><b>By giving us the access you agree that Verse will be able to:</b></Typography>
                    <Typography variant="h6" gutterBottom component="div">Your name and username, your profile picture, how many followers you have on Spotify and your public playlists</Typography>
                  </Box>
